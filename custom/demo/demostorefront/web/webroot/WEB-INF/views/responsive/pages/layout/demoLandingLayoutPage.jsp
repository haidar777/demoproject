    ...
    <div class="container-fluid unboxing">
        ...
        <div class="carousel__component--carousel js-owl-carousel js-owl-lazy-reference owl-carousel owl-grab">
            <div class="carousel__item" style="width: 270px;">
                ...
                <div class="desc">Keluarkan kasur INTHEBOX dari kemasannya secara perlahan-lahan</div>
            </div>
            <div class="carousel__item" style="width: 270px;">
            ...
            <div class="carousel__item" style="width: 270px;">
                ...
                <div class="desc">Lepaskan plastik pembungkus dan pastikan logo INTHEBOX ada di bawah</div>
            </div>
            <div class="carousel__item" style="width: 270px;">
                ...
                <div class="desc">Kasur INTHEBOX akan langsung mengembang. Tunggu 60 menit untuk digunakan.</div>
            </div>
        </div>
