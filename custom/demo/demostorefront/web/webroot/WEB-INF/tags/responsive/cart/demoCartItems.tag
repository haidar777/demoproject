...
<table class="demo-cart-table">
    ...
    <tr class="demo-cart-header">
        <th class="demo-cart-header-product">PRODUCT</th>
        <th class="demo-cart-header-qty">QUANTITY</th>
                        ...
                        <div>
                            ...
                            <form:form id="cartEntryActionForm" action="" method="post">
                                ...
                                <div class="js-execute-entry-action-button" id="actionEntry_${entryNumberHtml}"
                                    ...
                                    <a href="javascript:window.location.reload(true)" class="demo-cart-remove">REMOVE</a>
                                </div>
                            </form:form>
                        </div>
